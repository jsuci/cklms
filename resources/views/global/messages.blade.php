...
<body>
    ...
    <div class=" " id="main">
        ...
        @if(count($recipients)>0)
            <div class="chats-container margin-top-0">
                ...
                <div class="chats-container-inner" style="height: 100vh">

                    <!-- chats -->
                    <div class="chats-inbox" style="height: height: -webkit-fill-available;">
                        ...
                        <div class="chats-headline">
                            ...
                            <div class="d-flex">
                                <div class="avatar-parent-child">
                                    <img alt="Image placeholder" src="{{asset($recipients[0]->picurl)}}" class="avatar  rounded-circle avatar-sm" id="">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            var studid = '{{$recipients[0]->id}}'
            var usertype= '{{$recipients[0]->usertypeid}}'
            ...
            $(document).on('click','.chats-container-inner li', function(){
                        ...
                        $('input[name="recipientusertypeid"]').val(usertypeid);
                        loadMessages()
