            ...
            <div class="container">
                ...
                <div class="uk-grid-large mt-4 uk-grid" uk-grid="">
                    ...
                    <div class="uk-width-1-3@m">
                        <div class="course-card-trailer uk-sticky" uk-sticky="top: 10 ;offset:95 ; media: @m ; bottom:true" style="">
                            ...
                            <div id="trailer-modal" uk-modal="" class="uk-modal">
                                <div class="uk-modal-dialog">
                                    ...
                                    <div class="video-responsive">
                                        <iframe src="templatefiles/nOCXXHGMezU.html" class="uk-padding-remove uk-responsive-width" uk-video="automute: true" frameborder="0" allowfullscreen="" uk-responsive=""></iframe>
                                    </div>
                            ...
                            <div class="p-3">
                                ...
                                <div class="uk-child-width-1-2 uk-grid-small mb-4 uk-grid" uk-grid="">
                                    <div class="uk-first-column">
                                        <a href="#" class="uk-width-1-1 btn btn-default transition-3d-hover"> <i class="uil-play"></i> Start </a>
                                    </div>
                                    <div>
                        ...
                        </div><div class="uk-sticky-placeholder" style="height: 619px; margin: 0px;" hidden=""></div>
                    </div>
